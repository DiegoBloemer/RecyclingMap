...
async function initMap() {
  ...
  const contato_internet = document.createElement("div");
  contato_internet.className = "contato-internet";
  contato_internet.textContent = "Contato Internet";

const marker2 = new AdvancedMarkerElement({
  map,
  position: { lat: -28.953375003337133, lng: -49.50343503965838 },
  content: contato_internet,
});
