"""
Django settings for recycling_backend project.
...
SECRET_KEY = 'django-insecure-tfn=q7(j18dhfr_ocydm#34ac(=zf1i69!1n7ekhoau$t@1+)w'
...
WSGI_APPLICATION = 'recycling_backend.wsgi.application'
